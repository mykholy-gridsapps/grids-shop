...
import cls from './productFourtySeven.module.scss';

const ProductFourtySeven = () => {
  ...
  return (
    <div className={cls.productCard}>
      ...
      <div className={cls.details}>
        <h6>Smart watches wood edition watches wood edition</h6>
...
export default ProductFourtySeven;
