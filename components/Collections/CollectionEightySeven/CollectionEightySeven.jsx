...
import SaleSixtySix from '../../Sale/SaleSixty/SaleSixty';
...
import 'swiper/css';
import cls from './collectionEightySeven.module.scss';

const CollectionEightySeven = ({ reverse }) => {
...
export default CollectionEightySeven;
