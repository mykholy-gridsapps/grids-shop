    ...
    <div className={cls.topHeader}>
      <Container maxWidth="xl" className={`${cls.wrapper}`}>
        ...
        <div className={cls.options}>
          <span>
            <i className="fa-light fa-location-dot"></i> Store
          </span>
          <span onClick={() => router.push("/track-order")}>
            <i className="fa-light fa-truck"></i> Track
          </span>
          <span>
            <i className="fa-light fa-bag-shopping"></i> Shop
          </span>
          <span onClick={() => router.push("/account")}>
            <i className="fa-light fa-user"></i> Account
          </span>
        </div>
      </Container>
    </div>
